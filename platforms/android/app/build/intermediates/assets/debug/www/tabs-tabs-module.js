...
/*!*******************************************!*\
  !*** ./src/app/explorer/explorer.page.ts ***!
  \*******************************************/
/*! exports provided: ExplorerPage, snapshotToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ExplorerPage = /** @class */ (function () {
    function ExplorerPage(router) {
        ...
        this.router = router;
        this.muscles = [];
        this.ref = firebase__WEBPACK_IMPORTED_MODULE_2__["database"]().ref('muscles/');
        this.ref.on('value', function (resp) {
            _this.muscles = [];
            _this.muscles = snapshotToArray(resp);
        });
    }
...
/* harmony import */ var _explorer_explorer_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../explorer/explorer.page */ "./src/app/explorer/explorer.page.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchPage = /** @class */ (function () {
    function SearchPage() {
        this.muscles = [];
        this.ref = firebase__WEBPACK_IMPORTED_MODULE_1__["database"]().ref('muscles/');
    }
    SearchPage.prototype.getItems = function (searchbar) {
        var _this = this;
        this.ref.on('value', function (resp) {
            _this.muscles = [];
            _this.muscles = Object(_explorer_explorer_page__WEBPACK_IMPORTED_MODULE_2__["snapshotToArray"])(resp);
        });
