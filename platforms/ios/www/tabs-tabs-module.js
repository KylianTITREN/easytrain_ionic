...
var ExplorerPage = /** @class */ (function () {
    ...
    ExplorerPage.prototype.showExercices = function (id) {
        var _this = this;
        this.selectedIndex = id;
        _tabs_tabs_page__WEBPACK_IMPORTED_MODULE_2__["exercicesDB"].orderByChild('/idMuscles').equalTo(id).on('value', function (resp) {
            _this.exercices = [];
            _this.exercices = Object(_tabs_tabs_page__WEBPACK_IMPORTED_MODULE_2__["snapshotToArray"])(resp);
        });
...
/*!***********************************!*\
  !*** ./src/app/tabs/tabs.page.ts ***!
  \***********************************/
/*! exports provided: TabsPage, musclesDB, exercicesDB, snapshotToArray */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "exercicesDB", function() { return exercicesDB; });
...
var exercicesDB = firebase__WEBPACK_IMPORTED_MODULE_1__["database"]().ref('exercices/');
